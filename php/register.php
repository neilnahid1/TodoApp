...
$res = mysqli_query($link, "select Name from Roles");
        ...
        <div class="col-4">
            ...
            <form method="POST" action="register.php">
                <div class="form-group">
                    ...
                    <input name="username" type="username" class="form-control" id="emailField" aria-describedby="emailHelp" placeholder="Enter username">
                </div>
                <div class="form-group">
